...
function getBirthdayMessage() {
    ...
    if (birthdaySeg == "fundraisers") {
        document.getElementById('letter').innerHTML = "<div class='center-letter animate-reveal animate-first'> <h1>Happy Birthday!</h1><br><p style='margin: 0 10px; line-height:160%;'>Eh bien, encore un tour autour du soleil, hein ?<br><br>L'univers ne pouvait pas se passer de toi pour une année de plus! Que ton anniversaire soit aussi sensationnel que toi, rempli de joie, de succès et bien sûr, d'un gros gâteau.
        Merci d'être le clown de mon cirque cosmique. Joyeux anniversaire à toi, être céleste à l'humour aussi brillant que les étoiles !</p></div><div class='animate-reveal animate-second' style='margin-top: 15px;'> < href='placeholderlink' style='margin-top: 15px; font-family: Arial; background-color: #f79420; -webkit-border-radius: 4px; border-radius: 4px; color: #ffffff; display: block; margin: 0 auto; font-size: 22px; font-weight: 700; line-height: 36px; text-align: center; text-decoration: none; width: 280px; -webkit-text-size-adjust: none;' target='_blank'></div>"
     } /*else {
